...
/**
 * Kafka producer config for publishing FeedbackEvent
 * to the model.feedback topic.
 */
@Configuration
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, FeedbackEvent>
    producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, FeedbackEvent>
    kafkaTemplate() {
